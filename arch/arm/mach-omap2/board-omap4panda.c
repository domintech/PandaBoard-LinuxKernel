...
#endif
#if (defined(CONFIG_SENSORS_DMARD10) || defined(CONFIG_SENSORS_DMARD10_MODULE))
	{
		.type	        = "dmard10",
		.addr	        = 0x18,
		.flags	        = 0,
		//.platform_data = &dmard10_info,
	},
#endif
	{
		.type	        = "dmard06_accel",
...
static int __init omap4_panda_i2c_init(void)
{
	...
	omap_register_i2c_bus(2, 100, panda_i2c_boardinfo, ARRAY_SIZE(panda_i2c_boardinfo));
	/*
