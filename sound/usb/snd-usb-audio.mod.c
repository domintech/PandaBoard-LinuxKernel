...
__attribute__((section("__versions"))) = {
	...
	{ 0xa9d72cc5, "snd_usbmidi_create" },
	{ 0x8315589a, "malloc_sizes" },
	{ 0x220168f5, "usb_driver_set_configuration" },
	{ 0xf7802486, "__aeabi_uidivmod" },
	{ 0x2a3aa678, "_test_and_clear_bit" },
	{ 0xfed2410f, "usb_kill_urb" },
	{ 0xbb1eb479, "usb_reset_configuration" },
	{ 0xe2fae716, "kmemdup" },
	{ 0x1976aa06, "param_ops_bool" },
	{ 0x6f49c41f, "mutex_unlock" },
	{ 0x9c76fc29, "usb_autopm_get_interface" },
	{ 0x91715312, "sprintf" },
	{ 0x1c8d7ff2, "usb_unlink_urb" },
	{ 0x8a4b7523, "snd_card_disconnect" },
	{ 0x7d11c268, "jiffies" },
	{ 0xeeecb604, "down_read" },
	{ 0xe2d5255a, "strcmp" },
	{ 0xc4cdc048, "snd_pcm_suspend_all" },
	{ 0xaf8e8fef, "__init_waitqueue_head" },
	{ 0x3afc14b9, "usb_get_descriptor" },
	...
	{ 0x164d20c1, "usb_string" },
	{ 0x11089ac7, "_ctype" },
	{ 0x2f2d3cf, "_raw_spin_unlock_irqrestore" },
	{ 0xa6b60fda, "snd_pcm_hw_constraint_list" },
	...
	{ 0x558177eb, "snd_card_free_when_closed" },
	{ 0x6660842a, "snd_pcm_lib_get_vmalloc_page" },
	{ 0x891edc65, "usb_control_msg" },
	{ 0x73e20c1c, "strlcpy" },
	{ 0xd983adf9, "usb_driver_claim_interface" },
	{ 0x444cf97b, "snd_pcm_new_stream" },
	{ 0x16305289, "warn_slowpath_null" },
	{ 0xbb72d4fe, "__put_user_1" },
	{ 0x1e6d26a8, "strstr" },
	{ 0x9e34990c, "snd_hwdep_new" },
	{ 0xdc191cc, "snd_pcm_lib_ioctl" },
	{ 0x8e865d3c, "arm_delay_ops" },
	{ 0x1f644f47, "usb_free_coherent" },
	{ 0x911d82e5, "up_write" },
	{ 0x78c5f004, "down_write" },
	{ 0x8344ddd2, "snd_ctl_boolean_mono_info" },
	...
	{ 0x60afcb65, "snd_component_add" },
	{ 0x7b478dc5, "_snd_pcm_lib_alloc_vmalloc_buffer" },
	{ 0x22922f04, "usb_reset_device" },
	{ 0x3bd1b1f6, "msecs_to_jiffies" },
	{ 0x1000e51, "schedule" },
	{ 0x721d01af, "snd_ctl_new1" },
	{ 0x1e06d7c2, "__raw_spin_lock_init" },
	{ 0x94e2c648, "usb_interrupt_msg" },
...
MODULE_ALIAS("usb:v046Dp0990d*dc*dsc*dp*ic*isc*ip*in*");
...
MODULE_ALIAS("usb:v0582p006Ad*dc*dsc*dp*icFFisc*ip*in*");
...
MODULE_ALIAS("usb:v0582p0096d*dc*dsc*dp*ic*isc*ip*in*");
MODULE_ALIAS("usb:v0582p009Ad*dc*dsc*dp*ic*isc*ip*in*");
MODULE_ALIAS("usb:v0582p00A3d*dc*dsc*dp*ic*isc*ip*in*");
MODULE_ALIAS("usb:v0582p00A6d*dc*dsc*dp*ic*isc*ip*in*");
MODULE_ALIAS("usb:v0582p00ADd*dc*dsc*dp*ic*isc*ip*in*");
MODULE_ALIAS("usb:v0582p00B2d*dc*dsc*dp*ic*isc*ip*in*");
MODULE_ALIAS("usb:v0582p00C2d*dc*dsc*dp*ic*isc*ip*in*");
MODULE_ALIAS("usb:v0582p00C4d*dc*dsc*dp*ic*isc*ip*in*");
MODULE_ALIAS("usb:v0582p00DAd*dc*dsc*dp*ic*isc*ip*in*");
MODULE_ALIAS("usb:v0582p00E6d*dc*dsc*dp*icFFisc*ip*in*");
MODULE_ALIAS("usb:v0582p00E9d*dc*dsc*dp*icFFisc*ip*in*");
MODULE_ALIAS("usb:v0582p0104d*dc*dsc*dp*icFFisc*ip*in*");
MODULE_ALIAS("usb:v0582p0108d*dc*dsc*dp*icFFisc*ip*in*");
MODULE_ALIAS("usb:v0582p0109d*dc*dsc*dp*ic*isc*ip*in*");
MODULE_ALIAS("usb:v0582p010Fd*dc*dsc*dp*icFFisc*ip*in*");
MODULE_ALIAS("usb:v0582p0111d*dc*dsc*dp*ic*isc*ip*in*");
MODULE_ALIAS("usb:v0582p0113d*dc*dsc*dp*ic*isc*ip*in*");
MODULE_ALIAS("usb:v0582p0127d*dc*dsc*dp*ic*isc*ip*in*");
MODULE_ALIAS("usb:v0582p012Ad*dc*dsc*dp*ic*isc*ip*in*");
MODULE_ALIAS("usb:v0582p011Ed*dc*dsc*dp*ic*isc*ip*in*");
MODULE_ALIAS("usb:v0582p0130d*dc*dsc*dp*ic*isc*ip*in*");
MODULE_ALIAS("usb:v0582p014Dd*dc*dsc*dp*ic*isc*ip*in*");
...
MODULE_INFO(srcversion, "E2AF0F24F4A17C556D1628A");
